...
html_title = u'Como pensar como um Cientista da Computação: Edição Interativa em Python'

# A shorter title for the navigation bar.  Default is the same as html_title.
#html_short_title ='How to Think Like a Computer Scientist'
html_short_title = u'Como pensar como um Cientista da Computação'
...
html_last_updated_fmt = '%b %d, %Y' # coelho
...
html_show_sphinx = True # coelho

# If true, "(C) Copyright ..." is shown in the HTML footer. Default is True.
html_show_copyright = True # coelho
